...
const STATIC_FILES = {
  ...
  '/icons/icon-48.png':           { file: 'icons/icon-48.png',          type: 'image/png' },
  '/icons/icon-72.png':           { file: 'icons/icon-72.png',          type: 'image/png' },
  '/icons/icon-96.png':           { file: 'icons/icon-96.png',          type: 'image/png' },
  '/icons/icon-144.png':          { file: 'icons/icon-144.png',         type: 'image/png' },
  '/icons/icon-152.png':          { file: 'icons/icon-152.png',         type: 'image/png' },
  '/icons/icon-167.png':          { file: 'icons/icon-167.png',         type: 'image/png' },
  '/icons/icon-180.png':          { file: 'icons/icon-180.png',         type: 'image/png' },
  '/icons/icon-192.png':          { file: 'icons/icon-192.png',         type: 'image/png' },
  '/icons/icon-256.png':          { file: 'icons/icon-256.png',         type: 'image/png' },
  '/icons/icon-384.png':          { file: 'icons/icon-384.png',         type: 'image/png' },
  ...
  '/icons/favicon-16.png':        { file: 'icons/favicon-16.png',       type: 'image/png' },
  '/icons/favicon-32.png':        { file: 'icons/favicon-32.png',       type: 'image/png' },
  '/icons/favicon.ico':           { file: 'icons/favicon.ico',          type: 'image/x-icon' },
